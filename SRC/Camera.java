...
public class Camera extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        // AFFICHAGE DU FOND
        g.setColor((Listeners.louHammel) ?
        ...
        if (Game.over) {
            ...
            String toPrint = "YOU " + Game.whoWin;
            g.drawString(toPrint, (int) cameraWidth / 2 - toPrint.length() * g.getFont().getSize() / 4,
                         (int) cameraHeight / 2 + g.getFont().getSize() / 2);
        }
    }
}
