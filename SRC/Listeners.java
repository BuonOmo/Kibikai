...
public class Listeners implements Finals {
    ...
    public static Point2D mouse() {
        ...
        return new Point2D.Double((double) MouseInfo.getPointerInfo().getLocation().getX() / Camera.scale -
                                  border.getX(),
                                  (double) MouseInfo.getPointerInfo().getLocation().getY() / Camera.scale -
                                  border.getY());
    }
    ...
    public static Point2D mouseWithCameraOffset() {
        return new Point2D.Double((double) MouseInfo.getPointerInfo().getLocation().getX() / Camera.scale -
                                  border.getX() + Camera.cameraX,
                                  (double) MouseInfo.getPointerInfo().getLocation().getY() / Camera.scale -
                                  border.getY() + Camera.cameraY);
    }
