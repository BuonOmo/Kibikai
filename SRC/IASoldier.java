...
public class IASoldier extends IAUnite {
    ...
    public int calculateState() {
        ...
        if (soldierPlayerInZone3.size() * 0.8 > soldierComputerInZone3.size())
            state = 48 + state;
        else if (soldierPlayerInZone3.size() * 1.5 > soldierComputerInZone3.size())
            state = 96 + state;
